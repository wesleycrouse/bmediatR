...
```{r, include = F}
# To reduce package download time, the previous code chunk is not run and we will 
# load pre-saved results for this example.
load("presaved_DO_data.RData")
# save(map, null_m, null_y, null_m_scan, null_y_scan, null_y_qtl, null_m_qtl, null_qtl_effects, null_qtl_genoprobs, file = "presaved_DO_data.RData")
```
